                ...
                <div class="max-w-7xl mx-auto flex flex-col gap-8 pb-10">
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                            ...
                            <a href="/bienes/importar" class="flex flex-col items-center justify-center gap-3 bg-white hover:bg-primary-light border border-gray-200 hover:border-primary/50 rounded-xl p-6 transition-all group text-center h-40">
                                <div class="bg-gray-100 group-hover:bg-white p-3 rounded-full transition-colors shadow-sm">
